...
The aim of the project was to build a keyboard using JetpackCompose, based on the Nokia 3310 keyboard.
...
3. Build with Gradle.
5. As the official documentation says: <i>"Writing with the keypad is easy and fun"</i>, so have fun!

## Instruction of keyboard [1.]
